...
/**
 * A service that encapsulates an in-memory storage for testing and demo purpose.
 */
public class AddressServiceImpl implements AddressService {
  ...
  private void populateWithDefaultData() {
    ...
    addDefaultEntry("Lina Johansson", "Linas väg", "Göteborg", defaultCategory);
    addDefaultEntry("Erik Eriksson", "Eriksgatan", "Alingsås", defaultCategory);
    addDefaultEntry("Anders Andersson", "Anders väg", "Kungsbacka", defaultCategory);
  }
